  ...
  return {
    ...
    execute: function () {
      ...
      _export("LocalData", LocalData = {
        ...
        //领取了每日签到奖励后会调用这个函数
        refreshSigninData: function refreshSigninData(canGetDay, getTime) {
        ...
        setUserAuthorizationNickname: function setUserAuthorizationNickname(val) {
        ...
        getUserAuthorizationNickname: function getUserAuthorizationNickname() {
        ...
        initDefaultLocalData: function initDefaultLocalData() {
        ...
        load: function load() {
          var str = sys.localStorage.getItem("create_universe");
