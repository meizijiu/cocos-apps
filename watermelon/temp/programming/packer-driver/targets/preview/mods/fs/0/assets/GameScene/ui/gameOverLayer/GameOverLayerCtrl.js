System.register(["cce:/internal/code-quality/cr.mjs", "cc", "../../../GlobalScript/AudioCtrl", "../../../GlobalScript/AudioHelper", "../../../GlobalScript/NotificationCenter"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Label, CLIP, AudioHelper, NCKeys, NotificationCenter, _dec, _dec2, _class, _class2, _descriptor, _temp, _crd, ccclass, property, GameOverLayerCtrl;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "e10729w6qtFxK6zKpI9WBKm", "GameOverLayerCtrl", undefined);

      ccclass = _decorator.ccclass;
      property = _decorator.property;

      _export("GameOverLayerCtrl", GameOverLayerCtrl = (_dec = ccclass('GameOverLayerCtrl'), _dec2 = property(Label), _dec(_class = (_class2 = (_temp = /*#__PURE__*/function (_Component) {
        _inheritsLoose(GameOverLayerCtrl, _Component);

        function GameOverLayerCtrl() {
          var _this;
        ...
        var _proto = GameOverLayerCtrl.prototype;
...
//# sourceMappingURL=GameOverLayerCtrl.js.map