  ...
  return {
    ...
    execute: function () {
      ...
      _export("AudioHelper", AudioHelper = {
        ...
        //   }, this);
        // },
        play: function play(nodeName, clipIndex, loop, vol, newInstance) {
          if (loop === void 0) {
            loop = false;
          }
          ...
          var audioCtrl = node.getComponent(_crd && AudioCtrl === void 0 ? (_reportPossibleCrUseOfAudioCtrl({
            error: Error()
          }), AudioCtrl) : AudioCtrl);
          audioCtrl.play(clipIndex, loop, vol);
        },
        stop: function stop(nodeName, clipIndex) {
          var node = find(nodeName);
        ...
        getPlayState: function getPlayState(nodeName, clipIndex) {
          var node = find(nodeName);
        ...
        getInnerAudioUrl: function getInnerAudioUrl(nodeName, clipIndex) {
          // if (nodeName == 'audio') {
        ...
        needLoadAudioNode: function needLoadAudioNode() {
          return true;
        }
      });
