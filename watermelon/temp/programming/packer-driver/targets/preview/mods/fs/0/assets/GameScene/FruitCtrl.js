System.register(["cce:/internal/code-quality/cr.mjs", "cc", "../Config/fruit_config", "../GlobalScript/AudioCtrl", "../GlobalScript/AudioHelper", "../GlobalScript/NotificationCenter"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("FruitCtrl", FruitCtrl = (_dec = ccclass('FruitCtrl'), _dec2 = property(CCInteger), _dec(_class = (_class2 = (_temp = /*#__PURE__*/function (_Component) {
        _inheritsLoose(FruitCtrl, _Component);
        ...
        function FruitCtrl() {
          ...
          _this.state = 'FREE';
          _this.isPlayColliderAudio = false;
          return _this;
        }

        var _proto = FruitCtrl.prototype;

        _proto.onLoad = function onLoad() {
          var scale = (_crd && fruit_config === void 0 ? (_reportPossibleCrUseOffruit_config({
            error: Error()
          }), fruit_config) : fruit_config)[this.id].scale;
          this.node.scale = new Vec3(scale, scale, scale);
        };

        _proto.playBornAnimation = function playBornAnimation(startScale) {
          var _this2 = this;
        ...
        _proto.onCollisionExit = function onCollisionExit() {};

        _proto.solveCollision = function solveCollision(event) {
          var _this3 = this;
          ...
          var otherCtrl = event.otherCollider.getComponent(FruitCtrl);
          if (!otherCtrl) return;
          ...
          var tween = new Tween(otherCtrl.node);
          tween.to(0.1, {
            ...
            (_crd && NotificationCenter === void 0 ? (_reportPossibleCrUseOfNotificationCenter({
              ...
              id: _this3.id + 1,
              position: new Vec3(_this3.node.position)
            });
          }).start();
          (_crd && AudioHelper === void 0 ? (_reportPossibleCrUseOfAudioHelper({
            error: Error()
        ...
        return FruitCtrl;
      }(Component), _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "id", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
