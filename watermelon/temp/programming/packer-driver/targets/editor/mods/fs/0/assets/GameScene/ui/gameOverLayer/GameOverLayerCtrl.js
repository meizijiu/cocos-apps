System.register(["cce:/internal/code-quality/cr.mjs", "cc", "../../../GlobalScript/AudioCtrl", "../../../GlobalScript/AudioHelper", "../../../GlobalScript/NotificationCenter"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("GameOverLayerCtrl", GameOverLayerCtrl = (_dec = ccclass('GameOverLayerCtrl'), _dec2 = property(Label), _dec(_class = (_class2 = (_temp = class GameOverLayerCtrl extends Component {
        constructor(...args) {
          super(...args);
