  ...
  return {
    ...
    execute: function () {
      ...
      _export("LabelTickCtrl", LabelTickCtrl = (_dec = ccclass("LabelTickCtrl"), _dec2 = property(Label), _dec3 = property({
        ...
        type: CCString,
        multiline: true
      }), _dec5 = property(CCInteger), _dec(_class = (_class2 = (_temp = class LabelTickCtrl extends Component {
        constructor(...args) {
          super(...args);
          ...
          _initializerDefineProperty(this, "suffix", _descriptor3, this);

          _initializerDefineProperty(this, "decimalPlaces", _descriptor4, this);
        ...
        tickLabel(curNumber, finalNumber, duration = 1) {
