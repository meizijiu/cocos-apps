  ...
  return {
    ...
    execute: function () {
      ...
      LanguageTickParam = (_dec = ccclass('LanguageTickParam'), _dec2 = property(_crd && LabelTickCtrl === void 0 ? (_reportPossibleCrUseOfLabelTickCtrl({
        ...
        type: CCString
      }), _dec(_class = (_class2 = (_temp = class LanguageTickParam {
        constructor() {
      ...
      _export("LanguageLabelTicksCtrl", LanguageLabelTicksCtrl = (_dec5 = ccclass('LanguageLabelTicksCtrl'), _dec6 = property([LanguageTickParam]), _dec5(_class4 = (_class5 = (_temp2 = class LanguageLabelTicksCtrl extends Component {
        constructor(...args) {
          super(...args);

          _initializerDefineProperty(this, "params", _descriptor4, this);
        }
      ...
      }, _temp2), (_descriptor4 = _applyDecoratedDescriptor(_class5.prototype, "params", [_dec6], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
